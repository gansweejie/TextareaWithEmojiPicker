export default {
  ...
  searchDescription:
    "Apabila hasil carian tersedia, tekan atas atau bawah untuk memilih dan tekan masukkan untuk memilih.",
  searchLabel: "Cari",
  searchResultsLabel: "Hasil carian",
  skinToneDescription:
    "Apabila dikembangkan, tekan atas atau bawah untuk memilih dan tekan masukkan untuk memilih.",
